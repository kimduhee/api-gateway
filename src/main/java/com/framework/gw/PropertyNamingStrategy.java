...
public class PropertyNamingStrategy implements Serializable {
    ...
    /** @deprecated */
    @Deprecated
    public static final PropertyNamingStrategy UPPER_CAMEL_CASE = new PropertyNamingStrategy.UpperCamelCaseStrategy(false);
    /** @deprecated */
    @Deprecated
    public static final PropertyNamingStrategy SNAKE_CASE = new PropertyNamingStrategy.SnakeCaseStrategy(false);
    /** @deprecated */
    @Deprecated
    public static final PropertyNamingStrategy LOWER_CASE = new PropertyNamingStrategy.LowerCaseStrategy(false);
    /** @deprecated */
    @Deprecated
    public static final PropertyNamingStrategy KEBAB_CASE = new PropertyNamingStrategy.KebabCaseStrategy(false);
    /** @deprecated */
    @Deprecated
    public static final PropertyNamingStrategy LOWER_DOT_CASE = new PropertyNamingStrategy.LowerDotCaseStrategy(false);

    public static final PropertyNamingStrategy CONVERT_CASE = new PropertyNamingStrategy.ConvertCaseStrategy(false);
    ...
    public static class ConvertCaseStrategy extends PropertyNamingStrategy.PropertyNamingStrategyBase {
        public ConvertCaseStrategy() {
        }

        protected ConvertCaseStrategy(boolean logWarning) {
            super(logWarning);
        }
